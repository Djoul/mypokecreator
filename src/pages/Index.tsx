  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#FFE5F1] via-[#FFF5E1] to-[#E5F1FF] py-12 px-4 relative overflow-hidden">
      ...
      <footer className="absolute bottom-4 left-0 right-0 text-center text-sm text-gray-500">
        Pokémon is © 1995-2025 Nintendo. Made with <svg class="w-4 h-4 inline text-red-500" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/></svg> by <a href="https://x.com/JulienLeg78" class="text-gray-600 hover:text-gray-800">@JulienLeg78</a>
      </footer>
    </div>
  );
};
